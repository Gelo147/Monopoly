...
class Wid(Frame):
    ...
    def createGUI(self):        
        ...
        self.buffer4 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer4.grid(row=0, column=5)

        self.buffer5 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer5.grid(row=0, column=6)

        self.buffer6 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer6.grid(row=0, column=7)

        #Test button, will replace with buffer
        self.test = Button(self.top_frame, command=self.MakeChoice, height=2, width=5, bg="red", text="test")
        self.test.grid(row=0, column=8)

        self.buffer7 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer7.grid(row=0, column=9)

        self.buffer8 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer8.grid(row=0, column=10)

        self.buffer9 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer9.grid(row=0, column=11)

        self.buffer10 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer10.grid(row=0, column=12)

        self.buffer11 = Label(self.top_frame, height=2, width=5, bg="blue")
        self.buffer11.grid(row=0, column=13)

        self.buffer12 = Label(self.top_frame, height=2, width=25, bg="blue")
